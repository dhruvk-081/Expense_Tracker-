...
import { Table, Thead, Tbody, Tr, Th, Td, TableContainer, Card, CardBody, Badge, Button } from "@chakra-ui/react";
                ...
                {filteredExpenses.map((expenseobj, idx) => {
                  return (
                    <Tr key={uniqid()}>
                      ...
                      <Td>
                        <Badge colorScheme={expenseobj.expenseType === "EXPENSE" ? "red" : "green"}> {expenseobj.expenseType}</Badge>
                      </Td>
